...
u8 SEVENSEG_Enable_Ports[SEVENSEGMENTS_MAX_NUMBER]={SEVENSEG1_ENABLE_PORT,SEVENSEG2_ENABLE_PORT};
u8 SEVENSEG_Enable_PINS[SEVENSEGMENTS_MAX_NUMBER]={SEVENSEG1_ENABLE_PIN,SEVENSEG2_ENABLE_PIN};
...
void SEVENSEG_Enable(u8 SEVENSEG_NUMBER)
{
	/*
		Karim's way:
		#if SEVENSEG_MODE == 1
			SetPinValue(EVENSEG_ENABLE_PORT , EVENSEG_ENABLE_PIN , 0);

		#elif SEVENSEG_MODE == 0
			SetPinValue(EVENSEG_ENABLE_PORT , EVENSEG_ENABLE_PIN , 1);
